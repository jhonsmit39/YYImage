...
WEBP_EXTERN(void)
WebPDemuxDelete(WebPDemuxer *dmux);
...
WEBP_EXTERN(int)
WebPDemuxNextFrame(WebPIterator *iter);
WEBP_EXTERN(int)
WebPDemuxPrevFrame(WebPIterator *iter);
...
// WebPDemuxDelete().
WEBP_EXTERN(void)
WebPDemuxReleaseIterator(WebPIterator *iter);
...
WEBP_EXTERN(int)
WebPDemuxGetChunk(const WebPDemuxer *dmux,
                  const char fourcc[4],
                  int chunk_number,
...
// Returns true on success, false otherwise.
WEBP_EXTERN(int)
WebPDemuxNextChunk(WebPChunkIterator *iter);
WEBP_EXTERN(int)
WebPDemuxPrevChunk(WebPChunkIterator *iter);

// Releases any memory associated with 'iter'.
// Must be called before destroying the associated WebPDemuxer with
// WebPDemuxDelete().
WEBP_EXTERN(void)
WebPDemuxReleaseChunkIterator(WebPChunkIterator *iter);
...
//   True on success.
WEBP_EXTERN(int)
WebPAnimDecoderGetInfo(const WebPAnimDecoder *dec,
                       WebPAnimInfo *info);
...
WEBP_EXTERN(int)
WebPAnimDecoderGetNext(WebPAnimDecoder *dec,
                       uint8_t **buf,
                       int *timestamp);
...
WEBP_EXTERN(int)
WebPAnimDecoderHasMoreFrames(const WebPAnimDecoder *dec);
...
WEBP_EXTERN(void)
WebPAnimDecoderReset(WebPAnimDecoder *dec);
...
WEBP_EXTERN(void)
WebPAnimDecoderDelete(WebPAnimDecoder *dec);
