...
WEBP_EXTERN(uint8_t *)
WebPDecodeRGBA(const uint8_t *data, size_t data_size, int *width, int *height);
...
WEBP_EXTERN(uint8_t *)
WebPDecodeYUV(const uint8_t *data, size_t data_size, int *width, int *height, uint8_t **u, uint8_t **v, int *stride, int *uv_stride);
...
WEBP_EXTERN(int)
WebPInitDecBufferInternal(WebPDecBuffer *, int);
...
WEBP_EXTERN(void)
WebPFreeDecBuffer(WebPDecBuffer *buffer);
...
WebPINewDecoder(WebPDecBuffer *output_buffer);
...
// Internal, version-checked, entry point
WEBP_EXTERN(int)
WebPInitDecoderConfigInternal(WebPDecoderConfig *, int);
...
WEBP_EXTERN(WebPIDecoder *)
WebPIDecode(const uint8_t *data, size_t data_size, WebPDecoderConfig *config);
